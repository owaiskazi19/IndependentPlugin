 ...
 * ({@link TransportRequestOptions.Type}). This allows to tailor a connection towards a specific usage.
 */
public final class ConnectionProfile {
    ...
    public static class Builder {
         ...
         * @throws IllegalStateException if any of the {@link TransportRequestOptions.Type} enum is missing
         */
     ...
     * {@link TransportRequestOptions.Type#BULK} shares connections with
     * {@link TransportRequestOptions.Type#REG} they will return both the same number of connections from
