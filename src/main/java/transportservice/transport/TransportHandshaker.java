...
public final class TransportHandshaker {
    ...
    public static final String HANDSHAKE_ACTION_NAME = "internal:tcp/handshake";
    ...
    public interface HandshakeRequestSender {
        ...
        void sendRequest(DiscoveryNode node, transportservice.transport.TcpChannel channel, long requestId, Version version) throws IOException;
    }
}
