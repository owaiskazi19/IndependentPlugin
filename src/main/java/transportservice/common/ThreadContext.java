...
// */
//
//package transportservice.common;
//
...
//        final StoredContext storedContext = stashContext();
...
//            return new ContextPreservingAbstractRunnable((transportservice.common.AbstractRunnable) command);
//        }
...
//     */
//    private class ContextPreservingAbstractRunnable extends transportservice.common.AbstractRunnable implements WrappedRunnable {
//        private final transportservice.common.AbstractRunnable in;
//        private final StoredContext creatorsContext;
//
//        private StoredContext threadsOriginalContext = null;
//
//        private ContextPreservingAbstractRunnable(transportservice.common.AbstractRunnable in) {
...
//
//        @Override
//        public transportservice.common.AbstractRunnable unwrap() {
//            return in;
//        }
//    }
//
